...
const struct chainparams networks[] = {
    ...
    {.network_name = "liquid-regtest",
     .bip173_name = "ert",
     .genesis_blockhash = {{{.u.u8 = {0x06, 0x83, 0x88, 0xee, 0xfc, 0x88, 0xdd,
                      0xf3, 0x71, 0x3d, 0x84, 0x0d, 0xb3, 0x01,
                      0x21, 0x67, 0xbe, 0x93, 0xdc, 0x94, 0xb4,
                      0x87, 0xb3, 0x80, 0x6d, 0x73, 0xd8, 0xf2,
                      0x69, 0xc9, 0x82, 0x72}}}},
     .rpc_port = 19332,
     .cli = "elements-cli",
    ...
    {.network_name = "liquid",
     ...
     .bip32_key_version = {.bip32_pubkey_version = BIP32_VER_MAIN_PUBLIC,
			   .bip32_privkey_version = BIP32_VER_MAIN_PRIVATE},
     .is_elements = true},
    {.network_name = "elementsregtest",
     .bip173_name = "ert",
     .genesis_blockhash = {{{.u.u8 = {0x7d, 0xa0, 0xac, 0x2b, 0x49, 0x32, 0xe9,
                      0x50, 0x1c, 0x0e, 0x19, 0x2d, 0xfa, 0x8b,
                      0x4e, 0x6d, 0xdd, 0x80, 0x15, 0x62, 0xf8,
                      0x46, 0xbd, 0x04, 0x58, 0x4b, 0xbf, 0xa6,
                      0xbd, 0x77, 0x95, 0x20}}}},
     .rpc_port = 19332,
     .cli = "elements-cli",
     .cli_args = "-chain=elementsregtest",
     .dust_limit = {546},
     .max_funding = AMOUNT_SAT_INIT((1 << 24) - 1),
     .max_payment = AMOUNT_MSAT_INIT(0xFFFFFFFFULL),
     .when_lightning_became_cool = 1,
